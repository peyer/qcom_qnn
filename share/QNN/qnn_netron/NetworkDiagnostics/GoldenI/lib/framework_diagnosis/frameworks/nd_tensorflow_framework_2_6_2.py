...
class TensorFlowFramework_2_6_2(BaseFramework):
    __VERSION__ = '2.6.2'

    def __init__(self, logger):
        super(TensorFlowFramework_2_6_2, self).__init__(logger)
        self._graph = None
    ...
    def filter_blocks(self, tensor_pairs, block):
        ...
        for scope in scope_to_remove:
            tensor_pairs = TensorFlowFramework_2_3_0.filter_block(tensor_pairs, scope)
