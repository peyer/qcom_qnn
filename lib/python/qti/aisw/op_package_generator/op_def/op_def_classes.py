...
class SupplementalOpDefElement:
    def __init__(self, name, datatypes, shape, constraints, layout, default_only=False):
        self.name = name
        self.__datatypes = []
...
class EnumElement(RankZeroElement):
    ...
    def check_datatype(self, dtype):
        if dtype == QnnDatatype.QNN_DATATYPE_FLOAT_16 or dtype == QnnDatatype.QNN_DATATYPE_FLOAT_32:
