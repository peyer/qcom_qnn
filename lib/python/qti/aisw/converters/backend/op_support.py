...
converter_op_support = {
    ...
    "QNN_OP_CHANNEL_SHUFFLE": {ONNX: MATCHED, TENSORFLOW: MATCHED, PYTORCH: MATCHED},
    ...
    "QNN_OP_INSTANCE_NORM": {ONNX: "InstanceNormalization", TENSORFLOW: MATCHED},
    ...
    "QNN_OP_RESIZE_NEAREST_NEIGHBOR": {ONNX: "Resize", TENSORFLOW: "resize_nearest_neighbor"},
    "QNN_OP_ROI_ALIGN": {ONNX: "RoiAlign"},
