...
class ResultNode:
    def __init__(self, nodeName: str, tensorName: str, tensorType: str, results: Dict, scale: float = None, offset: int = None):
...
class WeightResultNode(ResultNode):
    def __init__(self, nodeName: str, tensorName: str, results: Dict, scale: float = None, offset: int = None) -> None:
