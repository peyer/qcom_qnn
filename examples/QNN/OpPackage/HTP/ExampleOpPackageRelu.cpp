...
DEF_PACKAGE_OPTIMIZATION(
    ...
    NOT(IS_FLOAT16("X")),
    Op("ReluMinMax",
       WITH_SAME_OUTPUT("X", Op(FROM_DEFAULT_PACKAGE("ConvLayer.opt.activations_to_vtcm"), "X")),
       "Min",
       "Max"))
...
DEF_PACKAGE_OPTIMIZATION(
    LATE + 20,
    Op("ReluMinMax", Op(FROM_DEFAULT_PACKAGE("flat_from_vtcm"), "X"), "Min", "Max"),
    NOT(IS_FLOAT16("X")),
    Op(FROM_DEFAULT_PACKAGE("flat_from_vtcm"), Op("ReluMinMax", "X", "Min", "Max")))
