...
// op declarations
DEF_PACKAGE_OP((maxpoolImpl<false, Tensor>), "MaxPool_valid")
...
DEF_PACKAGE_OP_AND_COST_F_AND_FLAGS((maxpoolOpt<QUint8CroutonTensor_TCM>),
                                    ...
                                    maxpoolCost,
                                    Flags::RESOURCE_HVX)
DEF_PACKAGE_OP((maxpoolOpt<QUint16CroutonTensor_TCM>), "MaxPool_valid.tcm")
...
DEF_PACKAGE_OPTIMIZATION(
    ...
    Op(FROM_DEFAULT_PACKAGE("ConvLayer.opt.activations_to_vtcm"),
       Op("MaxPool_valid", "In", "Window", "Stride")),
    OK,
    Op("MaxPool_valid.tcm",
       WITH_SAME_OUTPUT("In", Op(FROM_DEFAULT_PACKAGE("ConvLayer.opt.activations_to_vtcm"), "In")),
       "Window",
       "Stride"))
...
DEF_PACKAGE_OPTIMIZATION(LATE + 10,
                         ...
                         Op(FROM_DEFAULT_PACKAGE("ConvLayer.opt.activations_from_vtcm"),
                            Op("MaxPool_valid.tcm", "In", "Window", "Stride")))
...
DEF_PACKAGE_OPTIMIZATION(LATE + 11,
                         ...
                         AND(EQ(DIM_WIDTH("Window"), 1),
                             EQ(DIM_HEIGHT("Window"), 1),
                             OR(GT(DIM_WIDTH("Stride"), 1), GT(DIM_HEIGHT("Stride"), 1))),
                         Op(FROM_DEFAULT_PACKAGE("Decimate.tcm"), "In", "Stride"))
