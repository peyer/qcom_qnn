...
class string_tag_t {
    ...
    static registry_t *globalStringReg;
    // function to get its address
    static registry_t &get_stringreg_func();
    ...
    static string_key map_str(std::string_view s);
    static string_key map_str(std::string const &s);
    static string_key map_str(char const *s);
  ...
  public:
    ...
    static string_tag_t map_str_checked(std::string_view);
    ...
    bool operator==(std::string_view x) const; //{ return registry_t::unmap_sv(skey)==x;}
    bool operator==(std::string const &x) const; // { return registry_t::unmap_sv(skey)==x;}
    bool operator==(char const *x) const; //{ return registry_t::unmap_sv(skey)==std::string_view(x);}
...
//
__attribute__((visibility("default"))) opname_tag_t make_opname(char const *opname,
