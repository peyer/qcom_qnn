...
__attribute__((visibility("default"))) hnnx::Crate *get_lambda_crate();
...
inline ECtx &__attribute((always_inline)) fake_ectx()
{
    extern ECtx This_should_not_be_referenced;
...
inline bool __attribute__((always_inline)) reduce_logop(ECtx &e, OPERANDS const &operands)
{
