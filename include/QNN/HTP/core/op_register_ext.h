...
class PackageOpStorageBase {
  public:
    ...
    PackageOpStorageBase(const std::string_view op_name_in, const std::string_view type_tag_in,
...
#define INIT_PACKAGE_OP_DEF()                                                                                          \
    __attribute__((visibility("hidden"))) std::vector<std::unique_ptr<hnnx::PackageOpStorageBase>>                     \
