...
class Allocator {
  public:
    ...
    void *tracked_aligned_alloc(size_t al, size_t bytes, fa::BigBuff *const bb = nullptr);
    void tracked_free(void *aligned_ptr) noexcept;
	 ...
	 */
    virtual void serialize_block(Serializer &, const void *addr, const size_t block_size);
    /*
    ...
    virtual void serialize_blocks(Serializer &, const void *const *table, const size_t block_size, size_t nblocks);
    virtual void deserialize_blocks(Deserializer &, const void **table, size_t nblocks);
...
class FakeAllocator : public Allocator {
  public:
    ...
    virtual ~FakeAllocator();

    virtual void set_tcm_pool(void *base, size_t size) override;
    virtual void set_largest_memory_alloc_size(size_t size) override;
    virtual void deserialize(Deserializer &, unsigned char *weight_data = nullptr, size_t weight_length = 0) override;
    virtual void *deserialize_block(Deserializer &) override;
};
