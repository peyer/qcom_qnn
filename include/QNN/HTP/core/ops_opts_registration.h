...
class reg_op_table_wrapper {
    reg_op_table const *ptr;

  public:
    constexpr reg_op_table const *get_ptr() const noexcept { return ptr; }
    constexpr reg_op_table_wrapper(reg_op_table const *p) noexcept : ptr(p) {}
    constexpr reg_op_table_wrapper() noexcept : reg_op_table_wrapper(nullptr) {}
};
...
class reg_opt_table_wrapper {
    reg_opt_table const *ptr;

  public:
    constexpr reg_opt_table const *get_ptr() const noexcept { return ptr; }
    constexpr reg_opt_table_wrapper(reg_opt_table const *p) noexcept : ptr(p) {}
    constexpr reg_opt_table_wrapper() noexcept : reg_opt_table_wrapper(nullptr) {}
};
