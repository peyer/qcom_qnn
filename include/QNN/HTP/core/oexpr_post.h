...
class opdef_accessor {
  public:
    static OpRef lookup_operand(ECtx &e, hnnx::operand_tag_parm_t);
    static OpDef const &get_opdef(ECtx &e, hnnx::operand_tag_parm_t optag);
    static OpDef const &get_opdef(ECtx &e, OpRef);
    ...
    static OutputDef const &get_outputdef(ECtx &e, hnnx::operand_tag_parm_t optag);
    static OutputDef const &get_outputdef(ECtx &e, OpRef);
    static Split_Context const &lookup_split(ECtx &e, hnnx::split_context_tag_t const &tag);

    static OpRef get_input_of(ECtx &e, OpDef const *, int idx);
    static OpRef get_output_of(ECtx &e, OpRef, int idx);
...
struct property_extract_n_outputs : private opdef_accessor {
    typedef int otype;
    otype eval(ECtx &e, hnnx::operand_tag_parm_t ptag) const; // in oexpr.cc
    otype eval(ECtx &e, OpRef oref) const; // in oexpr.cc
  private:
    static otype eval_common(ECtx &e, OpDef const *od); // in oexpr.cc
};

struct property_extract_elementsize : private opdef_accessor {
    typedef size_t otype;
    otype eval(ECtx &e, hnnx::operand_tag_parm_t optag) const; // in oexpr.cc
    otype eval(ECtx &e, OpRef oref) const; // in oexpr.cc
};
...
struct property_data_size : private opdef_accessor {
    ...
    int eval(ECtx &e, const OpDef &op) const;
    int eval(ECtx &e, hnnx::operand_tag_parm_t ptag) const;
    int eval(ECtx &e, OpRef oref) const;
};
...
struct op_compare_same_encoding {
    typedef bool otype;
    otype eval(ECtx &e, OpDef const *a, OpDef const *b) const; // in oexpr.cc
};
