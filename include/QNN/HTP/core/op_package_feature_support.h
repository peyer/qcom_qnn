...
API_FUNC_EXPORT API_C_FUNC std::string API_FUNC_NAME(combine_pkg_op_name)(const char *package_name,
                                                                          const char *op_name);
 ...
 */
API_FUNC_EXPORT std::vector<ParamConfig_t> *add_to_param_map(ParamMap_t &pmap, std::string_view package_op_name);

// adds a new op parameter entry into a vector of parameter configs
API_FUNC_EXPORT void add_package_individual_param_config(std::vector<ParamConfig_t> *pvec, const char *param_name,
                                                         bool mandatory, void *default_val);

// base conditon for hnnx::add_package_param_configs_base
API_FUNC_EXPORT void add_package_param_configs_base(std::vector<ParamConfig_t> *pvec);

// adds a variable number of ParamConfig_t constructed from [param_name, mandatory, default_val] to a ParamConfig_t vector
template <typename... T>
API_FUNC_EXPORT void add_package_param_configs_base(std::vector<ParamConfig_t> *pvec, const char *param_name,
...
template <typename... T>
API_FUNC_EXPORT void add_package_param_configs(ParamMap_t &pmap, std::string_view package_op_name,
                                               const char *param_name, bool mandatory, void *default_val, T &&...args)
{
...
API_FUNC_EXPORT void add_package_axis_params(std::set<std::string> &aset);

// adds a variable number of axis parameter names into a set of axis parameter names
template <typename... T>
API_FUNC_EXPORT void add_package_axis_params(std::set<std::string> &aset, const char *param_name, T &&...args)
{
...
API_FUNC_EXPORT void add_package_per_channel_ops(std::set<std::string> &oset);

// adds a variable number of per-channel scaled package_name::op_name into a set of package_name::op_name
template <typename... T>
API_FUNC_EXPORT void add_package_per_channel_ops(std::set<std::string> &oset, const char *op_name, T &&...args)
{
...
#define INIT_PACKAGE_PARAM_ORDER_DEF()                                                                                 \
    API_FUNC_HIDDEN hnnx::ParamMap_t &current_package_param_order_storage_map_func()                                   \
    {                                                                                                                  \
...
#define LIST_PACKAGE_AXIS_PARAMS(...)                                                                                  \
    API_FUNC_HIDDEN std::set<std::string> &currentPackageParamAxesSetFunc()                                            \
    {                                                                                                                  \
...
#define LIST_PACKAGE_PER_CHANNEL_QUANTIZED_OPS(...)                                                                    \
    API_FUNC_HIDDEN std::set<std::string> &currentPackagePerChannelQuantizedOpsSetFunc()                               \
    {                                                                                                                  \
