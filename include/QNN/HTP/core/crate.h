...
class Crate {
  ...
  public:
    ...
    /// the crate.
    template <typename T, typename... Args> T *__attribute__((visibility("hidden"))) emplace(Args &&...args)
    {
    ...
    void *emplace_explicit(Deserializer &dctx, deserialize_op_func init_func, deserialize_dtor_func dtor_func,
    ...
    void erase(Graph *graph_in, void *p);
};
